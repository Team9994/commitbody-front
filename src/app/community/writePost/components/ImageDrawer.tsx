  ...
  return (
    <div>
      <Drawer open={imageDrawerOpen} onClose={handleDrawerToggle}>
        ...
        ></div>
        <div
          className={`fixed bg-backgrounds-sub h-[170px] max-w-[500px] w-full mx-auto text-text-main rounded-tl-[28px] rounded-tr-[28px] overflow-y-auto z-50 bottom-0 left-0 right-0 transition-transform duration-300 ease-in-out transform ${
