...
export default function EditPage() {
  return (
    <div className="bg-gray-900 text-white p-5 font-sans">
      ...
      <form className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-3">
            <input type="number" placeholder="1999" className="flex-1 bg-gray-800 p-3 rounded-md" />
            <input type="number" placeholder="12" className="flex-1 bg-gray-800 p-3 rounded-md" />
            <input type="number" placeholder="10" className="flex-1 bg-gray-800 p-3 rounded-md" />
          </div>
        </div>
